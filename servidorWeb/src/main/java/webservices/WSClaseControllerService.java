...
public class WSClaseControllerService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL(ConfigListener.cfg.getProperty("claseControllerURL"));
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WSClaseControllerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", ConfigListener.cfg.getProperty("claseControllerURL"));
        }
        WSDL_LOCATION = url;
    }
